      ...
      <PageContent>
        <Container class="container__account-dashboard">
          ...
          <main class="page__wrapper">
            ...
            <div class="page__section">
              <AccountHeading size="3">Available currencies</AccountHeading>
              <AccountTableConstructor :content="tableData" class="page__dashboard-table" />
            </div>
          </main>
        </Container>
      </PageContent>
...
<script>
  ...
  import AccountTableConstructor from '@/components/Account/AccountTableConstructor'
                            ...
                            content: [
                                {
                                    ...
                                    type: 'currency',
                                    data: {
                                        transactionFrom: 'Jopas',
                                        transactionTo: 'BTC'
                                    }
                                },
                                {
                                    id: 1,
                                    content: '18-11-30 - 21:00:23',
                                    align: 'left',
                                    type: 'date'
                                },
                                {
