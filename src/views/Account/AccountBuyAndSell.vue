      ...
      <Header />
        ...
        <AccountContainer>
          <div class="account-buy-and-sell__grid">
            ...
            <!-- trade amount -->
            <div class="account-buy-and-sell__trade-amount">
              <TradeAmount />
            </div>
            <!-- trade amount end -->

            <!-- trade details -->
            <div class="account-buy-and-sell__trade-details">
              <TradeDetails />
            </div>
            <!-- trade details end -->
...
<style lang="scss">
  ...
  .account-buy-and-sell__trade-amount {
    flex-shrink: 0;
    max-width: 256px;
    width: 100%;
  ...
  .account-buy-and-sell__trade-details {
    flex-shrink: 0;
    max-width: 256px;
    width: 100%;
  }
