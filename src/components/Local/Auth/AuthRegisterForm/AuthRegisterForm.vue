        ...
        <div :class="['auth-register-form__wrap']">
            <div :class="['auth-register-form__content']">
                ...
                <div :class="['auth-register-form__reCaptcha']">
                    <vue-recaptcha sitekey="6Ldg_IMUAAAAAJUF0SN5XfmvV6GLCZ2mB30RLEYJ" />
                    </div>
...
<script>
    ...
    import FormCheckbox from '@/components/Global/Form/FormCheckbox/FormCheckbox.vue'
    ...
    export default {
        ...
        methods: {
            ...
            validateDataForm: function () {
                ...
                else if (this.verifyRecaptcha !== true) {
                    this.setFormErrorLabel(999, 'You are robot?')
                }
        ...
        mounted () {
            ...
            this.$children[4].$on('verify', function () {
                self.verifyRecaptcha = true
            })
